    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col sm:flex-row items-stretch gap-5 group overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-between min-w-0">
        ...
        <div className="mt-6 flex flex-row gap-3 w-full">
          ...
          <button className="flex-1 rounded-xl border border-gray-200 px-2 sm:px-4 py-2.5 text-xs sm:text-sm font-bold text-gray-700 hover:bg-gray-50 transition cursor-pointer truncate">
            View Details
          </button>
        </div>
      </div>
