  ...
  return (
    <div className="mb-6">
      <div className="flex justify-between items-center mb-2.5">
        ...
        {timeLeft !== null && (
          <div className={`flex items-center gap-1.5 font-mono text-xs ${timeLeft <= 5 ? 'text-red-600 dark:text-red-400 font-bold animate-pulse' : 'text-gray-500 dark:text-slate-400 font-medium'}`}>
