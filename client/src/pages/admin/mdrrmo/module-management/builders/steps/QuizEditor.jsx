          ...
          <div className="p-4 border-t border-slate-200 space-y-4 bg-slate-50">
            ...
            <div>
              ...
              <select
                ...
                className="w-full p-3 bg-white border border-slate-300 rounded-xl text-sm font-medium text-slate-900 focus:outline-none focus:border-red-500 transition-all"
              >
              ...
              <textarea
                ...
                className={`w-full p-3 bg-white border ${
                  formErrors.questionText
                    ...
                    : "border-slate-300"
                } rounded-xl text-sm font-medium focus:outline-none focus:border-red-500 transition-all placeholder:text-slate-400`}
              />
              {formErrors.questionText && (
