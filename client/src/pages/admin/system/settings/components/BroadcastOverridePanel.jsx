  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm p-6">
      <div className="flex items-center gap-2 mb-2">
        <HugeiconsIcon icon={Notification01Icon} className="w-5 h-5 text-gray-500 dark:text-slate-400" />
        <h2 className="text-base font-bold text-gray-900 dark:text-white">Global Broadcast Override</h2>
      </div>
      ...
      >
        <div>
          <label htmlFor="broadcast_message" className="block text-xs font-bold text-gray-700 dark:text-slate-300 mb-1">
            Broadcast Message
          </label>
          <textarea
            ...
            className="w-full px-3 py-2 border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800/80 text-gray-900 dark:text-white rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-red-500 transition-all resize-none"
          />
        </div>
        <div className="flex items-center gap-3">
          <label className="text-xs font-bold text-gray-700 dark:text-slate-300">Status:</label>
          <div className="flex gap-4">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span className="text-sm text-gray-700 dark:text-slate-300">Disabled</span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="radio"
                ...
                className="w-4 h-4 text-red-600 focus:ring-red-500"
              />
              <span className="text-sm font-bold text-red-600 dark:text-red-400">Active</span>
            </label>
          </div>
        </div>
        <div className="flex flex-col gap-2 pt-2 border-t border-gray-100 dark:border-slate-800">
          <label className="text-xs font-bold text-gray-700 dark:text-slate-300">Severity Level:</label>
          <div className="flex gap-4">
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="radio"
              ...
              />
              <span className="text-sm text-blue-700 dark:text-blue-400 font-medium">Info (Blue)</span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="radio"
              ...
              />
              <span className="text-sm text-amber-700 dark:text-amber-400 font-medium">Warning (Yellow)</span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="radio"
                ...
                className="w-4 h-4 text-red-600 focus:ring-red-500"
              />
              <span className="text-sm text-red-700 dark:text-red-400 font-bold">Critical (Red)</span>
            </label>
          </div>
        </div>
