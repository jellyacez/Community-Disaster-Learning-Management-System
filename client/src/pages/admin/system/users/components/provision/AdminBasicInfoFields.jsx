  ...
  return (
    <>
      <div>
        ...
        <div className="relative">
          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            <HugeiconsIcon icon={UserIcon} size={18} className="text-gray-400 dark:text-slate-400" />
          </div>
          <input
            type="text"
            required
      ...
      <div>
        ...
        <div className="relative">
          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            <HugeiconsIcon icon={Mail02Icon} size={18} className="text-gray-400 dark:text-slate-400" />
          </div>
          <input
            type="email"
            required
