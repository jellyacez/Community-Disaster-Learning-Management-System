...
export default function ModuleDetailsPage() {
  ...
  if (isLoading) {
    return (
      <div className="max-w-4xl mx-auto space-y-8 p-4 md:p-6 animate-pulse">
        <div className="h-4 w-20 bg-gray-200 rounded-full" />
        <div className="bg-white rounded-3xl border border-gray-100 p-6 grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
          <div className="md:col-span-4 h-48 w-full bg-gray-200 rounded-2xl" />
